...
document.open();
document.write('<body style="margin: 0;"><script src="//katacoda.com/embed.js"></script><div data-katacoda-userid="RQ0ud8hjhztedQyWSyy8JTkBdx3F6FuMQGM58F2a" data-katacoda-id="mmumshad2/' + scenario + '" style="height: auto;"></div></body>');
document.close();
```
